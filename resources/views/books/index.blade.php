...
<table border="1">
    ...
    <tbody>
        ...
        <tr>
            <td colspan="5"></td>
            <td>買った値段の合計</td>
            <td style="text-align: right; width: 17%;"">{{ number_format($book->getTotalPurchasePrice(), 0) }}</td>
        </tr>
        <tr>
            <td colspan="5"></td>
            <td>売れた値段の合計</td>
            <td style="text-align: right;">{{ number_format($book->getTotalSellingPrice(), 0) }}</td>
        </tr>
        <tr>
            <td colspan="5"></td>
            <td>差額の合計</td>
            <td style="text-align: right;">{{ number_format($book->getDifference(), 0) }}</td>
        </tr>
